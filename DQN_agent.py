...
class DQN_agent():
    ...
    def __init__(self, id=0, train_mode=False): 
        self.id = id
        ...
        self.episodes = 0
        self.model_update_episodes = 1 # update traget network every x episodes
        self.model_save_rate = 200 # save model every x iterations
        self.print_logs_episodes = 1 # print logs every x episodes
    ...
    def save_model(self):
            ...
            print("## Saving model. Average Score: ", np.mean(self.all_scores))
    ...
    def train(self, current_state, action, next_state, reward, done):
        ...
        torch.nn.utils.clip_grad_norm_(self.main_network.parameters(), max_grad_norm) # clip gradients to 10.0
        self.optimizer.step()
